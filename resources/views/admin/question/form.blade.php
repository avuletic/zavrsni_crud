<div class="form-group {{ $errors->has('question_text') ? 'has-error' : ''}}">
    {!! Form::label('question_text', 'Pitanje', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('question_type', 'Tip pitanja', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::select('question_type', ['textarea' => 'Text','radio' => 'Radio Button']) !!}
    ...
    {!! Form::label('survey_id','Anketa ', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
