            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/admin/survey/create') }}" class="btn btn-success btn-sm" title="Add New Survey">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/survey', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Title</th><th>Description</th><th>User Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="pagination-wrapper"> {!! $survey->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
